...
exports.wsFormatter = exports.formatter = void 0;
...
function wsFormatter(websockets) {
    return function (target, name, descriptor) {
        const originalFunction = descriptor.value;
        descriptor.value = function (ws, req) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (ws) {
                    websockets[id] = ws;
                    ws.send(JSON.stringify((0, return_formatter_1.returnFormatter)({
                        status: 'connected'
                    })));
                }
            });
...
exports.wsFormatter = wsFormatter;
